...
return [
    ...
    'table' => [
        ...
        'tickets_count' => 'Consultations Count',
        'status' => 'Status',
        'actions' => 'Actions',
        'workers' => 'Workers',
    ...
    'subtitle' => 'Register a new company, then assign consultants from the consultant create or edit page.',
    'back' => 'Back to Companies',
    'notice' => 'After saving the company, assign one or more consultants from the consultant create or edit page.',
    'side_title' => 'Important Note',
    'side_text' => 'After saving the company, you can add workers and manage consultant and case category assignments from their dedicated sections.',
    'cancel' => 'Cancel',
    'save' => 'Save Company',
...
'form' => [
    ...
    'lawyer' => 'Assigned Consultant',
    'choose_lawyer' => 'Choose Consultant',
    'password' => 'Password',
...
'show' => [
    ...
    'lawyer_name' => 'Consultant Name',
    'lawyer_email' => 'Consultant Email',
    'lawyer_phone' => 'Consultant Phone',
    'lawyer_license' => 'Consultant License',
    'no_lawyer' => 'No consultant has been assigned to this company yet.',
    'case_categories' => 'Assigned Case Categories',
    ...
    'stats' => [
        ...
        'assigned_lawyer' => 'Assigned Consultants',
    ],
...
'edit' => [
    ...
    'subtitle' => 'Update company details and account settings. Consultant assignments are managed from the consultant create or edit page.',
    'back' => 'Back',
