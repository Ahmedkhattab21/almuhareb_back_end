...
return [
    ...
    'subtitle' => 'Register a new company, then assign lawyers from the lawyer create or edit page.',
    'back' => 'Back to Companies',
    'notice' => 'After saving the company, assign one or more lawyers from the lawyer create or edit page.',
    'side_title' => 'Important Note',
    'side_text' => 'After saving the company, you can add workers and manage lawyer and case category assignments from their dedicated sections.',
    'cancel' => 'Cancel',
    'save' => 'Save Company',
...
'show' => [
    ...
    'stats' => [
        ...
        'assigned_lawyer' => 'Assigned Lawyers',
    ],
...
'edit' => [
    ...
    'subtitle' => 'Update company details and account settings. Lawyer assignments are managed from the lawyer create or edit page.',
    'back' => 'Back',
