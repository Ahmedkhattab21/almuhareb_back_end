...
@section('title', __('lawyer_auth.login'))
    ...
    <div class="flex-1 flex items-center justify-center py-10">
        ...
        <div class="w-full max-w-[480px] bg-white rounded-2xl shadow-xl shadow-slate-300/40 px-8 sm:px-10 py-10 sm:py-12">
            ...
            <form
                id="lawyerLoginForm"
                method="POST"
                action="{{ route('lawyer.login.submit') }}"
            ...
            >
                ...
                <x-ui.input
                    label="{{ __('lawyer_auth.email') }}"
                    name="email"
                    type="email"
                    icon="email"
                    placeholder="lawyer@almuharib.com"
                ...
                >
                    <span class="btn-text">{{ __('lawyer_auth.login') }}</span>
                    ...
                    <span class="btn-loading hidden items-center justify-center gap-3">
                        ...
                        <span>{{ __('lawyer_auth.login') }}</span>
                    </span>
                </button>
            </form>
            ...
            <div class="mt-12 flex items-center justify-center gap-2 text-xs font-semibold tracking-wide text-slate-500 uppercase">
                ...
                <span>{{ __('lawyer_auth.secure') }}</span>
            </div>
