...
@section('content')
    ...
    <div class="space-y-6 lg:space-y-8">
        ...
        <section class="overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-sm">
            ...
            {{-- Filters Header --}}
            <form method="GET" action="{{ route('lawyer.companies.index') }}"
                ...
                <table class="w-full min-w-[1200px] text-sm">
                    ...
                    <thead class="bg-[#f8fbff] text-slate-500">
                        <tr>
                            ...
                            <th class="px-5 py-5 text-start font-bold">{{ __('companies.table.workers') }}</th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @forelse($companies as $company)
                            ...
                            <tr onclick="window.location.href='{{ route('lawyer.companies.show', $company->id) }}'"
                                ...
                                <td class="px-5 py-5 font-bold text-[#0f1b3d]">
                                    {{ number_format($company->workers_count ?? 0) }}
                                </td>
                            </tr>
                        @empty
                            <tr>
            ...
            <div class="grid gap-4 p-4 xl:hidden">
                @forelse($companies as $company)
                    ...
                    <div onclick="window.location.href='{{ route('lawyer.companies.show', $company->id) }}'"
