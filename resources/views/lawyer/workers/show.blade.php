...
@section('content')
    @php
        ...
        $imageUrl = !empty($worker->image) ? asset('storage/' . $worker->image) : null;
    @endphp
            ...
            <div class="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                <div class="text-start">
                    <div class="text-sm text-slate-500">
                        ...
                        <a href="{{ route('lawyer.workers.index') }}" class="font-bold text-slate-500 transition hover:text-[#0f1b3d]">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <a href="{{ route('lawyer.workers.index') }}"
                ...
                <div class="text-center lg:text-start">
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-3 text-sm sm:grid-cols-2 xl:grid-cols-3">
                        <div class="flex items-center justify-center gap-2 rounded-2xl bg-[#f8fbff] px-4 py-3 lg:justify-start">
                            <svg class="h-5 w-5 text-[#5368aa]" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24">
                            ...
                            <span class="font-extrabold text-[#0f1b3d]">{{ $worker->phone ?? '-' }}</span>
                        </div>
                        ...
                        <div class="flex items-center justify-center gap-2 rounded-2xl bg-[#f8fbff] px-4 py-3 lg:justify-start">
                            ...
                            <span class="font-extrabold text-[#0f1b3d]">{{ $worker->email ?? '-' }}</span>
                        </div>
                        ...
                        <div class="flex items-center justify-center gap-2 rounded-2xl bg-[#f8fbff] px-4 py-3 lg:justify-start">
                            ...
                            <span class="font-extrabold text-[#0f1b3d]">{{ $companyName }}</span>
                        </div>
                    </div>
                </div>
        ...
        <section class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
            <div class="rounded-[26px] border border-slate-200 bg-white p-6 shadow-sm">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        <p class="text-sm font-bold text-slate-500">{{ __('workers.table.company') }}</p>
                        <h3 class="mt-4 text-xl font-black text-[#0f1b3d]">{{ $companyName }}</h3>
                    </div>
            ...
            <div class="rounded-[26px] border border-slate-200 bg-white p-6 shadow-sm">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        <p class="text-sm font-bold text-slate-500">{{ __('workers.table.nationality') }}</p>
                        <h3 class="mt-4 text-2xl font-black text-[#0f1b3d]">{{ $nationalityLabel }}</h3>
                    </div>
            ...
            <div class="rounded-[26px] border border-slate-200 bg-white p-6 shadow-sm">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        <p class="text-sm font-bold text-slate-500">{{ __('workers.table.prefered_language') }}</p>
                        <h3 class="mt-4 text-2xl font-black text-[#0f1b3d]">{{ $languageLabel }}</h3>
                    </div>
            ...
            <div class="rounded-[26px] border border-slate-200 bg-white p-6 shadow-sm">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        <p class="text-sm font-bold text-slate-500">{{ __('workers.table.status') }}</p>
                        <div class="mt-4">
        ...
        <section class="grid grid-cols-1 gap-6 xl:grid-cols-3">
            <div class="overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-sm">
                <div class="flex items-center justify-between border-b border-slate-100 px-5 py-5">
                    <h2 class="text-lg font-black text-[#0f1b3d]">{{ __('workers.show.sections.personal') }}</h2>
                </div>
            ...
            <div class="overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-sm">
                <div class="flex items-center justify-between border-b border-slate-100 px-5 py-5">
                    <h2 class="text-lg font-black text-[#0f1b3d]">{{ __('workers.show.sections.work') }}</h2>
                </div>
            ...
            <div class="overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-sm">
                <div class="flex items-center justify-between border-b border-slate-100 px-5 py-5">
                    <h2 class="text-lg font-black text-[#0f1b3d]">{{ __('workers.show.sections.system') }}</h2>
                </div>
