...
@section('title', __('company_auth.login'))
...
<div class="relative min-h-screen px-4 py-8 flex flex-col">
    ...
    <div class="flex-1 flex items-center justify-center py-10">
        ...
        <div class="w-full max-w-[480px] bg-white rounded-2xl shadow-xl shadow-slate-300/40 px-8 sm:px-10 py-10 sm:py-12">
            ...
            >
                ...
                <x-ui.input
                    label="{{ __('company_auth.email') }}"
                    name="email"
                    type="email"
                    icon="email"
                    placeholder="company@almuharib.com"
                ...
                >
                    <span class="btn-text">{{ __('company_auth.login') }}</span>
                    ...
                    <span class="btn-loading hidden items-center justify-center gap-3">
                        ...
                        <span>{{ __('company_auth.login') }}</span>
                    </span>
                </button>
            </form>
            ...
            <div class="mt-12 flex items-center justify-center gap-2 text-xs font-semibold tracking-wide text-slate-500 uppercase">
                ...
                <span>{{ __('company_auth.secure') }}</span>
            </div>
    ...
    <div class="text-center text-sm text-slate-600 pb-6">
        {{ __('company_auth.support_text') }}
        <a href="#" class="font-semibold text-blue-700 hover:underline">
            {{ __('company_auth.support_link') }}
        </a>
    </div>
...
<script>
    ...
    document.getElementById('companyLoginForm').addEventListener('submit', function () {
        const button = document.getElementById('companyLoginSubmitBtn');
