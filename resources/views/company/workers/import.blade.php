...
<div class="space-y-8" dir="rtl">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
            <p class="text-sm font-bold text-slate-500">لوحة الشركة / إدارة العمال</p>
            <h1 class="mt-2 text-4xl font-black text-[#0f1b3d]">استيراد العمال دفعة واحدة</h1>
            <p class="mt-2 text-sm leading-7 text-slate-500">
                ارفع ملف CSV أو XLSX، وحدد الوظيفة والجنسية واللغة والمدينة مرة واحدة ليتم تطبيقها على كل العمال داخل الملف.
            </p>
        </div>
