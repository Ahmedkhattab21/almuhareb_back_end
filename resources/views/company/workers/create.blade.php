...
@section('title', __('company_workers.create.page_title'))
...
@section('content')
    ...
    <div class="space-y-6 lg:space-y-8">
            ...
            <div class="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                ...
                <div class="text-start">
                    <div class="text-sm text-slate-500">
                        ...
                        <span class="font-bold text-[#0f1b3d]">
                            {{ __('company_workers.create.breadcrumb_current') }}
                        </span>
                    </div>
                    ...
                    <div class="mt-3 flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-3xl font-black tracking-tight text-[#0f1b3d] sm:text-4xl">
                                {{ __('company_workers.create.title') }}
                            </h1>

                            <p class="mt-2 text-sm leading-7 text-slate-500">
                                {{ __('company_workers.create.subtitle') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="shrink-0">
                    <a href="{{ $indexUrl }}"
                        ...
                        {{ __('company_workers.create.back') }}
                    </a>
                </div>
        ...
        <form
            method="POST"
            action="{{ route('company.workers.store') }}"
            ...
            <aside class="hidden xl:block">
                <div class="sticky top-6 rounded-[26px] border border-slate-200 bg-white p-6 text-center shadow-sm">
                    ...
                    <h3 class="mt-5 text-lg font-black text-[#0f1b3d]">
                        {{ __('company_workers.create.side_title') }}
                    </h3>

                    <p class="mt-3 text-sm leading-7 text-slate-500">
                        {{ __('company_workers.create.side_text') }}
                    </p>
                </div>
            </aside>
            ...
            <div class="space-y-5">
                ...
                <div class="flex items-start gap-3 rounded-2xl border border-blue-100 bg-blue-50 p-4 text-blue-800">
                    ...
                    <p class="text-sm font-bold leading-7">
                        {{ __('company_workers.create.notice') }}
                    </p>
                </div>
                    ...
                    <div class="flex items-center justify-between border-b border-slate-100 px-5 py-5">
                        <div class="flex items-center gap-3">
                            ...
                            <h2 class="text-lg font-black text-[#0f1b3d]">
                                {{ __('company_workers.create.sections.personal') }}
                            </h2>
                        </div>
                    </div>
                        ...
                        <div class="md:col-span-2 xl:col-span-3">
                            ...
                            >
                                ...
                                <span id="workerImageText" class="mt-3 text-sm font-black text-[#0f1b3d]">
                                    {{ __('company_workers.form.image_upload') }}
                                </span>
                ...
                <section class="overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-sm">
                    <div class="flex items-center justify-between border-b border-slate-100 px-5 py-5">
                        <div class="flex items-center gap-3">
                            ...
                            <h2 class="text-lg font-black text-[#0f1b3d]">
                                {{ __('company_workers.create.sections.work') }}
                            </h2>
                        </div>
                    </div>
                ...
                <section class="overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-sm">
                    <div class="flex items-center justify-between border-b border-slate-100 px-5 py-5">
                        <div class="flex items-center gap-3">
                            ...
                            <h2 class="text-lg font-black text-[#0f1b3d]">
                                {{ __('company_workers.create.sections.account') }}
                            </h2>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-5 p-5 md:grid-cols-2">
                        ...
                        <div>
                            <label class="mb-2 block text-sm font-extrabold text-[#0f1b3d]">
                                {{ __('company_workers.form.password') }}
                            </label>
                        ...
                        <div>
                            <label class="mb-2 block text-sm font-extrabold text-[#0f1b3d]">
                                {{ __('company_workers.form.password_confirmation') }}
                            </label>
                ...
                <div class="rounded-[26px] border border-slate-200 bg-white p-5 shadow-sm">
                    <div class="flex flex-wrap items-center justify-end gap-3">
                        ...
                        <a href="{{ $indexUrl }}"
                            ...
                            {{ __('company_workers.create.cancel') }}
                        </a>
                        ...
                        <button
                            ...
                            data-loading-button
                            data-loading-id="company-worker-create-save-and-add"
                            data-loading-text="{{ __('company_workers.loading.saving') }}"
                            class="inline-flex h-12 w-[170px] flex-none items-center justify-center gap-2 rounded-2xl border border-[#5368aa] bg-white px-4 text-sm font-extrabold text-[#5368aa] transition hover:bg-[#eef3ff]"
                        >
                            {{ __('company_workers.create.save_and_add_another') }}
                        </button>
                        ...
                        <button
                            ...
                            value="save"
                            data-loading-button
                            data-loading-id="company-worker-create-save"
                            data-loading-text="{{ __('company_workers.loading.saving') }}"
                        ...
                        >
                            {{ __('company_workers.create.save') }}
                        </button>
