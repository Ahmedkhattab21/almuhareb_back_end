...
@section('title', __('company_positions.edit.page_title'))
...
@section('content')
    <div class="space-y-6 lg:space-y-8">
                ...
                <div class="text-start">
                    <div class="text-sm text-slate-500">
                        ...
                        <span class="font-bold text-[#0f1b3d]">
                            {{ __('company_positions.edit.breadcrumb_current') }}
                        </span>
                    </div>

                    <h1 class="mt-2 text-3xl font-black tracking-tight text-[#0f1b3d] sm:text-4xl">
                        {{ __('company_positions.edit.title') }}
                    </h1>

                    <p class="mt-2 text-sm leading-7 text-slate-500">
                        {{ __('company_positions.edit.subtitle') }}
                    </p>
                </div>

                <div class="flex flex-wrap items-center gap-3">
                    <a href="{{ route('company.positions.show', $position->id) }}"
                        ...
                        {{ __('company_positions.edit.show_position') }}
                    </a>
                    ...
                    <a href="{{ route('company.positions.index') }}"
                        ...
                        {{ __('company_positions.edit.back') }}
                    </a>
                </div>
        ...
        <form
            method="POST"
            action="{{ route('company.positions.update', $position->id) }}"
            autocomplete="off"
            data-loading-form
            class="space-y-5"
        >
                ...
                <div class="flex items-center justify-between border-b border-slate-100 px-5 py-5">
                    <div class="flex items-center gap-3">
                        ...
                        <h2 class="text-lg font-black text-[#0f1b3d]">
                            {{ __('company_positions.edit.sections.basic') }}
                        </h2>
                    </div>
                </div>
            ...
            <div class="rounded-[26px] border border-slate-200 bg-white p-5 shadow-sm">
                <div class="flex flex-wrap items-center justify-end gap-3">
                    ...
                    <a href="{{ route('company.positions.show', $position->id) }}"
                        ...
                        {{ __('company_positions.edit.cancel') }}
                    </a>
                    ...
                    <button
                        ...
                        value="save_and_show"
                        data-loading-button
                        data-loading-id="company-position-edit-save-show"
                        data-loading-text="{{ __('company_positions.loading.saving') }}"
                        class="inline-flex h-12 w-[145px] flex-none items-center justify-center gap-2 rounded-2xl border border-[#5368aa] bg-white px-4 text-sm font-extrabold text-[#5368aa] transition hover:bg-[#eef3ff]"
                    >
                        {{ __('company_positions.edit.save_and_show') }}
                    </button>
                    ...
                    <button
                        ...
                        value="save"
                        data-loading-button
                        data-loading-id="company-position-edit-save"
                        data-loading-text="{{ __('company_positions.loading.saving') }}"
                    ...
                    >
                        {{ __('company_positions.edit.save') }}
                    </button>
