...
<div class="mx-auto max-w-4xl space-y-6">
    <section class="flex items-center justify-between gap-4">
        ...
        <a href="{{ route('company.company-news.show', $newsItem) }}" class="rounded-2xl border border-slate-200 px-5 py-3 text-sm font-bold text-[#0f1b3d]">
            {{ __('company_news.actions.back') }}
        </a>
    </section>

    <form method="POST" action="{{ route('company.company-news.update', $newsItem) }}" enctype="multipart/form-data"
