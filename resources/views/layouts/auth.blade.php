@php
    ...
    $hasToast = session()->has('toast_success') || session()->has('toast_error');
@endphp
...
<body class="min-h-screen bg-white antialiased">
    ...
    @if ($hasToast)
        @php
            $toastType = session()->has('toast_success') ? 'success' : 'error';

            $toastMessage = session('toast_success') ?? session('toast_error');

            $toastTitle = $toastType === 'success'
                ? (Lang::has('messages.success') ? __('messages.success') : 'Success')
                : (Lang::has('messages.error') ? __('messages.error') : 'Error');
