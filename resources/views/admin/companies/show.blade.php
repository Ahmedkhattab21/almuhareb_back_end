            ...
            <div class="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <a
                        ...
                        class="inline-flex h-12 items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-5 text-sm font-extrabold text-blue-700 shadow-sm transition hover:bg-blue-50"
                    >
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24">
                            <path d="M12 20h9" />
                            <path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z" />
                        </svg>
                        {{ __('companies.show.edit') }}
                    </a>

                    @if(Route::has('admin.workers.create'))
                        <a
                            href="{{ route('admin.workers.create', ['company_id' => $company->id]) }}"
                            class="inline-flex h-12 items-center justify-center gap-2 rounded-2xl bg-[#0f1b3d] px-5 text-sm font-extrabold text-white shadow-md transition hover:bg-[#16264f]"
                        >
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24">
        ...
        <section class="overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-sm">
            <div class="flex flex-col gap-3 border-b border-slate-100 px-5 py-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                @if(Route::has('admin.workers.create'))
                    <a
                        href="{{ route('admin.workers.create', ['company_id' => $company->id]) }}"
                        class="inline-flex h-11 items-center justify-center gap-2 rounded-2xl bg-[#0f1b3d] px-5 text-sm font-extrabold text-white shadow-sm transition hover:bg-[#16264f]"
                    >
                        {{ __('companies.show.add_worker') }}
                    </a>
                @endif
