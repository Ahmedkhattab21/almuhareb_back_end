...
@section('title', __('positions.create.page_title'))
                ...
                <div class="text-start">
                    <div class="text-sm text-slate-500">
                        ...
                        <span class="font-bold text-[#0f1b3d]">
                            {{ __('positions.create.breadcrumb_current') }}
                        </span>
                    </div>

                    <h1 class="mt-2 text-3xl font-black tracking-tight text-[#0f1b3d] sm:text-4xl">
                        {{ __('positions.create.title') }}
                    </h1>

                    <p class="mt-2 text-sm leading-7 text-slate-500">
                        {{ __('positions.create.subtitle') }}
                    </p>
                </div>
                ...
                <div class="flex items-center justify-between border-b border-slate-100 px-5 py-5">
                    <div class="flex items-center gap-3">
                        ...
                        <h2 class="text-lg font-black text-[#0f1b3d]">
                            {{ __('positions.create.sections.basic') }}
                        </h2>
                    </div>
                </div>
            ...
            <div class="rounded-[26px] border border-slate-200 bg-white p-5 shadow-sm">
                <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end">
                    ...
                    <button
                        ...
                        value="save_and_show"
                        data-loading-button
                        data-loading-id="position-create-save-show"
                    ...
                    >
                        {{ __('positions.create.save_and_show') }}
                    </button>
