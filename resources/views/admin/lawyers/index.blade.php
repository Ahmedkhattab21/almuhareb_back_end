                ...
                <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <select name="specialization"
                            ...
                            <option value="">{{ __('lawyers.filters.all_specializations') }}</option>
                ...
                <table class="w-full min-w-[1350px] text-sm">
                    ...
                    <thead class="bg-[#f8fbff] text-slate-500">
                        <tr>
                            ...
                            <th class="px-5 py-5 text-start font-bold">{{ __('lawyers.table.license_number') }}</th>
                            <th class="px-5 py-5 text-start font-bold">{{ __('lawyers.table.specialization') }}</th>
                        ...
                        @forelse($lawyers as $lawyer)
                            ...
                            <tr class="transition hover:bg-slate-50">
                                ...
                                <td class="px-5 py-5">
                                    <div class="flex items-center gap-3">
                                        @if (!empty($lawyer->avatar))
                                            <img src="{{ asset('storage/' . $lawyer->avatar) }}"
                                                alt="{{ $lawyer->name }}" class="h-11 w-11 rounded-full object-cover">
                                        @else
                                            <div
                                ...
                                <td class="px-5 py-5 font-bold text-[#0f1b3d]">
                                    {{ $lawyer->specialization ?? __('lawyers.table.not_defined') }}
                                </td>
                                ...
                                <td class="px-5 py-5">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="h-2.5 w-20 overflow-hidden rounded-full bg-slate-100">
                                            <div class="h-full rounded-full bg-[#5368aa]"
                ...
                @forelse($lawyers as $lawyer)
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                        ...
                        <div class="flex items-start justify-between gap-3">
                            <div class="flex items-center gap-3">
                                @if (!empty($lawyer->avatar))
                                    <img src="{{ asset('storage/' . $lawyer->avatar) }}" alt="{{ $lawyer->name }}"
                        ...
                        <div class="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3">
                            ...
                            <div class="rounded-xl bg-[#f8fbff] p-3">
                                <p class="text-xs text-slate-400">
                                    {{ __('lawyers.table.license_short') }}
                                </p>
                            ...
                            <div class="rounded-xl bg-[#f8fbff] p-3">
                                <p class="text-xs text-slate-400">
                                    {{ __('lawyers.table.specialization') }}
                                </p>
                        ...
                        <div class="mt-4 flex items-center gap-2">
                            ...
                            <form method="POST"
                                action="{{ Route::has('admin.lawyers.destroy') ? route('admin.lawyers.destroy', $lawyer->id) : '#' }}"
                                class="flex-1" onsubmit="return confirm('{{ __('lawyers.actions.confirm_delete') }}')">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        @if ($lawyers->hasPages())
                            <div class="flex items-center justify-end gap-2">
                                ...
                                @else
                                    <a href="{{ $lawyers->previousPageUrl() }}"
